...
{!! HTML::link('/panel/products/sizes/create', 'Add', ['class' => 'btn btn-primary btn-sm pull-right']) !!}
<div class="clear">&nbsp;</div>
<hr/>
    ...
    <tr>
        ...
        <td>
            <div>
                ...
                <a class="text-warning" title="Modify" href="{{{ url('panel/products/sizes/' . $size -> id . '/edit') }}}"><span class="fa fa-edit"> </span></a>
                <a class="delete text-danger" title="Delete" data-id=""><span class="glyphicon glyphicon-trash"> </span></a>
            </div>
            <div class="hidden">
                {!! Form::open(array('url' => 'panel/products/sizes/' . $size -> id, 'method' => 'delete')) !!}
                <p>Are you sure you want to delete category "{{{ $size -> name  }}}"?</p>
