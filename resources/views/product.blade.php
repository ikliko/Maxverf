                        ...
                        <span>
                            ...
                            @else
                                ...
                                @if($product -> promoPrice())
                                    <span class="promotion-price">{{{ strtoupper(Lang::get('fields.product.promo.incl')) }}}: {{{ $product -> promoNoVat()  }}}</span>
                                    <span class="promotion-price">{{{ strtoupper(Lang::get('fields.product.promo.excl')) }}}: {{{ $product -> promoPrice()  }}}</span>
                                @endif
